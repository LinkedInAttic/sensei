...
//	public PartitionedLoadBalancer newRouter(Node[] nodes) throws InvalidClusterException {
...
//	}
   ...
   */
  public PartitionedLoadBalancer<Integer> newLoadBalancer(Node[] nodes) throws InvalidClusterException
  {
    final Int2ObjectMap<ArrayList<Node>> nodeMap = new Int2ObjectOpenHashMap<ArrayList<Node>>();
    IntSet parts = new IntOpenHashSet();
    for (Node node : nodes){
