...
public class SchemaIndexingExample{
  ...
  public static void main(String[] args) throws Exception{
    ...
    IndexWriter idxWriter = new IndexWriter(SimpleFSDirectory.open(idxDir),new StandardAnalyzer(Version.LUCENE_30),MaxFieldLength.UNLIMITED);
    while(true){
