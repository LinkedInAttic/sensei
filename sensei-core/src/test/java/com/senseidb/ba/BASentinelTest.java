...
public class BASentinelTest  extends TestCase {
  ...
  protected void setUp() throws Exception {    
    File ConfDir1 = new File(SenseiStarter.class.getClassLoader().getResource("ba-conf").toURI());
  ...
  String req = "{" + 
   ...
   JSONObject resp = search(new URL("http://localhost:8078/sensei"), new JSONObject(req).toString());
